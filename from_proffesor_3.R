...
#Remove Maine from data that is used train model
#Either delete from states or training_data subset

training_data <- subset(training_data, 
                        training_data$name != "Maine")
...
#Nevada also looks like an outlier
#Remove Nevada from data that is used train model
#Either delete from states or training_data subset

training_data <- subset(training_data, 
                        training_data$name != "Nevada")
